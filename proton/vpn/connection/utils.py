    ...
    def __init__(self):
        ...
        # If we run as a normal user
            ...
            if BaseDirectory is not None:
                ...
                # WARNING : If the security of your run time directory is critical, be sure to use
                # this class on environment where XDG_RUNTIME_DIR is defined.
                # Why :
                # if XDG_RUNTIME_DIR is defined, strict=False is ignored and  the
                # behavior of this function is equivalent to get_runtime_dir(strict=True).
                # otherwhise it will fallback on a less secure directory than what's specified here :
                # https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html
                runtime_dir = BaseDirectory.get_runtime_dir(strict=False)
